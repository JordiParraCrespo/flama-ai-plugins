...
import { MEMBER_LISTS_KEY, usersKeys } from '@flama/frontend-core/react';
import type { CreateRoleDto, UpdateRoleDto } from '@flama/shared';
import {
...
export function useAssignUserRoles(
  ...
  return useMutation({
    ...
    onSuccess: (...args) => {
      ...
      queryClient.invalidateQueries({ queryKey: MEMBER_LISTS_KEY });
