import { AuthorizationApi, type RoleResponseDto, RolesApi } from '@flama/api-client';
import { AppError, MapApiError } from '@flama/frontend-core';
import type { CreateRoleDto, PermissionDefinition, UpdateRoleDto } from '@flama/shared';
