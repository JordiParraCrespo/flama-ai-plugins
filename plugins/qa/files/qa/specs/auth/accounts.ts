...
export const TRANSIENT: Record<string, TransientAccount> = {
  resetMember: {
    email: 'reset.member@qa.flama.dev',
    password: 'QaResetMember123',
    firstName: 'Rita',
    lastName: 'Reset',
  },
  inviteeAdmin: {
    email: 'invitee.admin@qa.flama.dev',
    password: 'QaInviteeAdmin123',
    firstName: 'Ines',
    lastName: 'Invited',
  },
  inviteeMember: {
    email: 'invitee.member@qa.flama.dev',
    password: 'QaInviteeMember123',
    firstName: 'Ivan',
    lastName: 'Invited',
  },
  newcomer: {
    email: 'newcomer@qa.flama.dev',
    password: 'QaNewcomer123',
    firstName: 'Nora',
    lastName: 'Newcomer',
  },
  revokedMember: {
    email: 'revoked.member@qa.flama.dev',
...
export const SEEDED = {
  superAdmin: { email: 'superadmin@flama.dev', password: 'superadmin123456' },
};
