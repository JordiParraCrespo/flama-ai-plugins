 ...
 * `@qa.flama.dev` is a distinct domain from the platform seed's `@flama.dev`
...
export const FIXTURE_ACCOUNTS = {
  baseline: {
    email: 'owner.baseline@qa.flama.dev',
  ...
  volume: {
    email: 'owner.volume@qa.flama.dev',
  ...
  empty: {
    email: 'owner.empty@qa.flama.dev',
    password: 'QaEmpty123',
    firstName: 'Emi',
    lastName: 'Empty',
  ...
  roster: {
    email: 'owner.roster@qa.flama.dev',
...
export const ROSTER_CAST = [
  {
    email: 'member.admin.roster@qa.flama.dev',
  ...
  {
    email: 'member.plain.roster@qa.flama.dev',
  ...
  {
    email: 'member.platform.roster@qa.flama.dev',
...
export const QA_EMAIL_DOMAIN = 'qa.flama.dev';
...
export const TRANSIENT_ACCOUNTS = [
  'reset.member@qa.flama.dev',
  'invitee.admin@qa.flama.dev',
  'invitee.member@qa.flama.dev',
  'newcomer@qa.flama.dev',
  'revoked.member@qa.flama.dev',
] as const;
