...
- ✅ the request is confirmed without disclosing whether the account exists — Flama
Check your email

We sent a password reset link to reset.member@qa.flama.dev. It expires in 30 minutes.
...
- ✅ the reset link cannot be replayed — Flama
Invalid link
...
- ✅ the owner can invite invitee.admin@qa.flama.dev as admin — HTTP 201 
- ✅ the owner can invite invitee.member@qa.flama.dev as member — HTTP 201 
...
- ✅ the admin invitee has an account — invitee.admin@qa.flama.dev
...
- ✅ the member invitee has an account — invitee.member@qa.flama.dev
...
- ❌ AUTH-04d: an unissued reset token reaches the invalid-link state — Flama
Reset password
...
- ✅ the account exists in the database — newcomer@qa.flama.dev
...
- ✅ the first screen says where the reader stands rather than refusing them — Flama
